 ...
 * Wbty_gallery model.
 */
class Wbty_galleryModelpricing_set extends JModelItem
{
	/**
	...
	public function &getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('pricing_set.id');
		...
		if (!isset($this->_item[$pk])) {
                        ...
                        $query->from('#__wbty_gallery_pricing_sets AS a');
						...
						$query->select('*');
						$query->from('#__wbty_gallery_price');
						$query->where('pricing_set_id = '.(int)$data->id);
						
						$data->prices = $db->setQuery($query)->loadObjectList();
